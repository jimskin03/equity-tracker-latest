  ...
  return (
    <section className="portfolio-stack">
      <header className="app-header">
        <div><p className="eyebrow">Portfolio</p><h1>Equity Tracker</h1><p className="muted header-copy">Track holdings by ISIN. Security names come from OpenFIGI; latest prices from Yahoo Finance. Holdings are synced to your private Supabase portfolio account.</p></div>
